...
# while True:
#         try :
#             cante=int(input("ingrese la cantidad de empleados a registrar"))
#         except Exception :
#             print("solo numeros enteros")
#         nam=int(input("ingrese ls años de antiguedad"))
#         for i in range(cante):
#             print(f" la persona {cante} tiene {antiguedad}años  de antiguedad")
#             print( i+1)
#             antig=int(input("ingrese años de antiguedad"))
#         if antig>=antiguedad:
#             print("tiene mas de 10 años de antiguedad")
#         elif antig<= antiguedad:
#             print("tiene menos de 10 años de antiguedad")